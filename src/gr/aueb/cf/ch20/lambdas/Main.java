...
public class Main {
    ...
    private static final List<Teacher> teachers = Arrays.asList(new Teacher(1, "A.", "Cooper"), new Teacher(2, "B.", "Dylan"),
...
//    }
    ...
    public static void filterAndPrintLTIId(List<Teacher> teachers, int id) {
        for (Teacher teacher : teachers) {
            if (teacher.getTeacherID() <= id) {
                System.out.println("Full name: " + teacher.getFirstname() + ", " + teacher.getLastname());
            }
